...
INSERT INTO `sprints` VALUES (1,'demo1','2025.10.1-2025.10.7','In progress','2026-03-22 04:09:00','2026-04-29 04:09:00',5,2),(2,'this is a demo','2025.10.8-2025.10.14','completed','2026-04-01 22:39:00','2026-04-14 22:39:00',3,3);
...
CREATE TABLE `tasks` (
  ...
  `stage` varchar(50) DEFAULT 'Analysis',
  `sprint_id` int DEFAULT NULL,
  `user_story` varchar(255) DEFAULT 'New User Story',
  `feedback` text,
  `code_url` varchar(255) DEFAULT NULL,
  `test_case_url` varchar(255) DEFAULT NULL,
  `is_uat_issue` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `tasks` VALUES (1,'Progress report export function','11111\n','High',NULL,NULL,'Business Analyst','inProgress',50,'Development',2,'New User Story',NULL,NULL,NULL,0),(2,'demo','。。。。。。。','Medium',NULL,NULL,'Product Manager','todo',80,'Development',2,'New User Story',NULL,NULL,NULL,0),(5,'demo 2','this is a demo\n','Medium',NULL,NULL,'Developer','inProgress',0,'Analysis',1,'New User Story',NULL,NULL,NULL,0),(6,'Design the login page UI',NULL,'High',NULL,NULL,'Osman','completed',0,'Development',1,'New User Story',NULL,NULL,NULL,0),(7,'Implement user authentication API',NULL,'High',NULL,NULL,'Desmond','completed',0,'Testing',1,'New User Story',NULL,NULL,NULL,0),(8,'Database schema design',NULL,'Medium',NULL,NULL,'Lucas','inProgress',0,'Development',2,'New User Story',NULL,NULL,NULL,0),(11,'ths is demo 2','','Medium',NULL,NULL,'osman','inProgress',7,'Development',1,'New User Story',NULL,NULL,NULL,0),(12,'test1 ',NULL,'Medium',NULL,NULL,'','inProgress',0,'Development',1,'New User Story',NULL,NULL,NULL,0),(13,'test1 ',NULL,'Medium',NULL,NULL,NULL,'todo',0,'Analysis',NULL,'New User Story',NULL,NULL,NULL,0),(14,'',NULL,'Medium',NULL,NULL,NULL,'inProgress',0,'Analysis',NULL,'New User Story',NULL,NULL,NULL,0),(15,'test2',NULL,'Medium',NULL,NULL,'Developer','todo',0,'Analysis',1,'New User Story',NULL,NULL,NULL,0);
...
-- Dump completed on 2026-04-15 18:01:58
