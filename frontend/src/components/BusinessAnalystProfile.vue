...
.user-story-section { margin-top: 1rem; }
.user-story-content pre { background: #f3f4f6; padding: 1rem; border-radius: 8px; white-space: pre-wrap; }
.no-story { color: #9ca3af; font-style: italic; }
</style>